 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  | Space|           | Space|   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Ctrl   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |   '"   |
 * |--------+------+------+------+------+------| ~L1  |           | ~L1  |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Hyper|  Esc | Ctrl | Alt  | LGui |                                       | RGui |   [  |   ]  |  Grv |   L1   |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Del  | Home |       | PgUp | BkSp   |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        ALL_T(KC_NO),  KC_ESC,       CTL_T(KC_NO), KC_LALT, KC_LGUI,
                                                                     KC_DELT, KC_HOME,
                                                                              KC_END,
                                                       CTL_T(KC_NO), KC_SPC,  KC_LGUI,
        // right hand
        KC_RGHT,      KC_6,         KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
        KC_SPC,     KC_Y,         KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS,
                      KC_H,         KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        MO(SYMB),     KC_N,         KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                    KC_RGUI, KC_LBRC, KC_RBRC, KC_GRV,  TG(SYMB),
        KC_PGUP,      KC_BSPC,
        KC_PGDN,
