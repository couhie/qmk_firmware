 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Del  |  Esc | Ctrl | Alt  | LGui |                                       | RGui |   [  |   ]  |  Grv | BkSp   |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | ~L1  | Home |       | PgUp | ~L1    |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_DELT,       KC_ESC,       CTL_T(KC_NO), KC_LALT, KC_LGUI,
                                                                     MO(SYMB), KC_HOME,
                                                                               KC_END,
                                                       CTL_T(KC_NO), KC_SPC,   KC_LALT,
        // right hand
        KC_RGHT,      KC_6,     KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
        TG(SYMB),     KC_Y,     KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS,
                      KC_H,     KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        ALL_T(KC_NO), KC_N,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                KC_RGUI, KC_LBRC, KC_RBRC, KC_GRV,  KC_BSPC,
        KC_PGUP,      MO(SYMB),
        KC_PGDN,
